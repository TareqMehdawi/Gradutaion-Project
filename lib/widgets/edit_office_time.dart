...
class EditOfficeHoursFormPageState extends State<EditOfficeHoursFormPage> {
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              setState(() {
                                ...
                                officeHours=startTime.toString().substring(10,15)+' - '+endTime.toString().substring(10,15);
                                print(officeHours);
                              });
                            },
                          ),
                    ...
                    child: Align(
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              updateOfficeTimeField(officeHours: ttt() ,day: days,time: officeHours);
                            },
                            child: const Text(
                              'Update',
  ...
  Future updateOfficeTimeField({required Map officeHours,required List<String>day , required String time} ) async{
